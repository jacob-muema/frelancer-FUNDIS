  ...
  <aside class="sidebar" id="sidebar">
      ...
      <div class="sidebar-menu">
          <div class="menu-section">
              ...
              <ul class="menu-items">
                  <li class="menu-item">
                      <a href="client-dashboard.php" class="menu-link active">
                          <i class="fas fa-tachometer-alt"></i> Dashboard
                      </a>
                  </li>
                  <li class="menu-item">
                      <a href="#" class="menu-link" id="post-job-link">
                          <i class="fas fa-plus-circle"></i> Post a Job
                      </a>
                  </li>
                  <li class="menu-item">
                      <a href="#" class="menu-link" onclick="switchTab('reports')">
                          <i class="fas fa-chart-bar"></i> Reports
                      </a>
                  </li>
                  <li class="menu-item">
                      <a href="#" class="menu-link" onclick="switchTab('payments')">
      ...
      <div id="overview" class="tab-content active">
          <div class="dashboard-section">
              <div class="section-header">
                  ...
                  <a href="#" class="section-action" onclick="switchTab('reports')">View All <i class="fas fa-arrow-right"></i></a>
              </div>
              <div class="card">
                  <div class="card-body">
                              ...
                              <tbody>
                                  ...
                                  if ($jobs_result->num_rows > 0): 
                                      while ($job = $jobs_result->fetch_assoc()): 
                                          if ($count++ < 5): // Show only 5 recent jobs
                                  ?>
                                      <tr>
                                          ...
                                          <td>
                                              <div class="btn-group">
                                                  ...
                                                  <?php endif; ?>
                                                  <a href="view-job.php?id=<?php echo $job['id']; ?>" class="btn btn-outline btn-sm">
          ...
          <div class="dashboard-section">
              <div class="section-header">
                  ...
                  <a href="#" class="section-action" onclick="switchTab('payments')">View All <i class="fas fa-arrow-right"></i></a>
              </div>
              <div class="card">
                  <div class="card-body">
                      <div class="table-responsive">
