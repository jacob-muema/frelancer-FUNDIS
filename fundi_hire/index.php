...
<head>
    ...
    <title>FundiHire - Connect with Skilled Professionals</title>
    ...
    <main>
        ...
        <section class="hero">
            <div class="hero-content">
                <h1>Connect with Skilled <span>Fundis</span> Directly</h1>
                <p>Find reliable professionals for your projects or offer your skills as a Fundi</p>
                <div class="btn-group">
        ...
        <section id="user-types" class="user-types">
            <div class="container">
                <div class="section-title">
                    <h2>Join FundiHire Today</h2>
                    <p>Whether you need to hire a skilled professional or you are a Fundi looking for work, FundiHire connects you directly</p>
                </div>
                <div class="user-types-grid">
                    ...
                    <div class="user-card">
                        ...
                        <div class="user-content">
                            <h3>I Need a Fundi</h3>
                            <p>Post your job, connect with skilled professionals, and hire the best Fundi for your project.</p>
                    ...
                    <div class="user-card">
                        ...
                        <div class="user-content">
                            ...
                            <a href="register.php?type=fundi" class="user-btn">Register as Fundi</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="fundi-skills">
            <div class="container">
                <div class="section-title">
                    <h2>Showcase Your Skills as a Fundi</h2>
                ...
                <div class="skills-container">
                    ...
                    <div class="skill-item">
                        ...
                        <div class="skill-name">Transport</div>
                    </div>
                    ...
                    <div class="skill-item">
                        ...
                        <div class="skill-name">Landscaping</div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="fundis-grid">
                    ...
                    <div class="fundi-card">
                        ...
                        <div class="fundi-content">
                            <h3>Jane Smith</h3>
                            <span class="skill">Electrician</span>
                            <div class="rating">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                            ...
                            <a href="register.php?type=client1" class="fundi-btn">Electrician</a>
                        </div>
                    </div>
        ...
        <section id="how-it-works" class="how-it-works">
            <div class="container">
                <div class="section-title">
                    <h2>How FundiHire Works</h2>
                    <p>Connecting clients and fundis in three simple steps</p>
                </div>
                <div class="steps">
                    <!-- Step 1 -->
                    <div class="step">
        ...
        <section class="testimonials">
            <div class="container">
                ...
                <div class="testimonials-grid">
                    ...
                    <div class="testimonial-card">
                        <div class="testimonial-content">
                            <p>As a plumber, FundiHire has connected me with many clients in my area. The platform is easy to use and I've been able to grow my business significantly.</p>
                            <div class="testimonial-author">
                                <div class="author-img">
                    ...
                    <div class="testimonial-card">
                        <div class="testimonial-content">
                            <p>I've hired multiple fundis through this platform for my renovation project. The direct communication and ability to see reviews helped me find the right professionals.</p>
                            <div class="testimonial-author">
                                <div class="author-img">
        ...
        <section class="cta">
            <div class="container">
                ...
                <p>Join FundiHire today and experience the easiest way to connect clients with skilled fundis.</p>
